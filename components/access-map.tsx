...
export function AccessMap() {
  return (
    <section id="access" className="bg-background py-10 md:py-16 lg:py-24">
      <div className="mx-auto max-w-3xl px-4 md:px-8 lg:px-10">
        ...
        <FadeIn delay={0.3}>
          <div className="mt-8 grid grid-cols-1 gap-px border border-border/40 bg-border/40 text-center md:grid-cols-2">
